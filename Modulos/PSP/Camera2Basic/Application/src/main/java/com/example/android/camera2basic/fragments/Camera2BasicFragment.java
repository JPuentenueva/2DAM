...
package com.example.android.camera2basic.fragments;
...
import com.example.android.camera2basic.interfaces.FileUploadService;
...
public class Camera2BasicFragment extends Fragment
    ...
    static String FORMAT_DATE = "dd-MM-yyyy_HH:mm:ss";
    ...
    private void takePicture() {
        ...
        mFile = new File(getActivity().getExternalFilesDir(null), "Pic_" + timeStamp + ".jpg");
        lockFocus();
    }
    ...
    public void upload() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(FileUploadService.ENDPOINT)
