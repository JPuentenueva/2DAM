 ...
 * specified {@link IProductoListener}.
 * TODO: Replace the implementation with code for your data type.
 */
public class ProductosAdapter extends RecyclerView.Adapter<ProductosAdapter.ViewHolder> {

    private final List<Producto> mValues;
    private final IProductoListener mListener;

    public ProductosAdapter(List<Producto> items, IProductoListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onClickProducto(holder.mItem);
                }
            }
        });
    }
